...
namespace HBSIS.ReservaMesas.UnitTests.Domain.Validators
{
    ...
    {
        private readonly FloorValidator _validator;

        public FloorValidatorTest()
        {
            _validator = new FloorValidator();
        }
        ...
        {
            var floor = new Floor(name, true, "01-03", 1);

            _validator.ShouldHaveValidationErrorFor(floor => floor.Name, floor)
