...
export default function SvgComponent(props: React.SVGProps<SVGSVGElement>) {
  ...
  workstationsMap.set('01-10-01-01', UserRectStatus.available);
  workstationsMap.set('01-10-01-02', UserRectStatus.available);
  workstationsMap.set('01-10-01-03', UserRectStatus.available);
  workstationsMap.set('01-10-01-04', UserRectStatus.available);
  workstationsMap.set('01-10-01-05', UserRectStatus.available);
  workstationsMap.set('01-10-01-06', UserRectStatus.available);
  workstationsMap.set('01-10-01-07', UserRectStatus.available);
  workstationsMap.set('01-10-01-08', UserRectStatus.available);
  workstationsMap.set('01-10-01-09', UserRectStatus.available);
  workstationsMap.set('01-10-01-10', UserRectStatus.available);
  workstationsMap.set('01-10-01-11', UserRectStatus.available);
  workstationsMap.set('01-10-01-12', UserRectStatus.available);
  workstationsMap.set('01-10-01-13', UserRectStatus.available);
  workstationsMap.set('01-10-01-14', UserRectStatus.available);
  workstationsMap.set('01-10-01-15', UserRectStatus.available);
  workstationsMap.set('01-10-01-16', UserRectStatus.available);
