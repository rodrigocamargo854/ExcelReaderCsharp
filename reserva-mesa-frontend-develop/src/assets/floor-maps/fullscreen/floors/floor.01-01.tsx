...
export default function SvgComponent(props: React.SVGProps<SVGSVGElement>) {
  ...
  workstationsMap.set('01-01-01-01', FullscreenRectStatus.available);
  workstationsMap.set('01-01-01-02', FullscreenRectStatus.available);
  workstationsMap.set('01-01-01-03', FullscreenRectStatus.available);
  workstationsMap.set('01-01-01-04', FullscreenRectStatus.available);
  workstationsMap.set('01-01-01-05', FullscreenRectStatus.available);
  workstationsMap.set('01-01-01-06', FullscreenRectStatus.available);
  workstationsMap.set('01-01-01-07', FullscreenRectStatus.available);
  workstationsMap.set('01-01-01-08', FullscreenRectStatus.available);
  workstationsMap.set('01-01-01-09', FullscreenRectStatus.available);
  workstationsMap.set('01-01-01-10', FullscreenRectStatus.available);
  workstationsMap.set('01-01-01-11', FullscreenRectStatus.available);
  workstationsMap.set('01-01-01-12', FullscreenRectStatus.available);
  workstationsMap.set('01-01-01-13', FullscreenRectStatus.available);
  workstationsMap.set('01-01-01-14', FullscreenRectStatus.available);
  workstationsMap.set('01-01-01-15', FullscreenRectStatus.available);
  workstationsMap.set('01-01-01-16', FullscreenRectStatus.available);
